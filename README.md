...
AmznKiller is an Xposed module built on the modern LSPosed API that removes ads, "Sponsored" products, video carousels, and other promotional junk from the Amazon Android app.
